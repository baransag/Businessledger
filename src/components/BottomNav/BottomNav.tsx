...
const BottomNav: React.FC<BottomNavProps> = ({ onAddTransaction }) => (
  <nav className="bottom-nav" aria-label="Mobile navigation">
    ...
    <NavLink to="/accounts" className={({ isActive }) => `bottom-nav-item ${isActive ? 'active' : ''}`}>
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="6" width="20" height="14" rx="2"/><path d="M2 10h20"/><path d="M6 14h4"/></svg>
      <span>Accounts</span>
    </NavLink>
